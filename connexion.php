...
<body>
    ...
    <form class="formm">
        ...
        <br>
        <input type="text" id="password" name="passwrdCo" required class="inputtexte" placeholder="Mot de passe">

        <br>
        <input type="submit" name="connexion" value="Connexion" class="inputsubmit">
